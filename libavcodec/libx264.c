...
static enum AVPixelFormat csp_to_pixfmt(int csp)
{
    ...
    case X264_CSP_I400 | X264_CSP_HIGH_DEPTH:
        return AV_PIX_FMT_GRAY10;
#endif
    case X264_CSP_I420:
        return AV_PIX_FMT_YUV420P;
    case X264_CSP_I420 | X264_CSP_HIGH_DEPTH:
        return AV_PIX_FMT_YUV420P10;
    case X264_CSP_I422:
        return AV_PIX_FMT_YUV422P;
    case X264_CSP_I422 | X264_CSP_HIGH_DEPTH:
        return AV_PIX_FMT_YUV422P10;
    case X264_CSP_I444:
        return AV_PIX_FMT_YUV444P;
    case X264_CSP_I444 | X264_CSP_HIGH_DEPTH:
                       ...
                       x264_picture_t **ppic)
{
    ...
    *ppic = NULL;
    ...
    if (x4->a53_cc)
    {
        ...
        {
            /* Jagwire */
            x4->pic.extra_sei.payloads = av_realloc(x4->pic.extra_sei.payloads, sizeof(x4->pic.extra_sei.payloads[0]) * (sei_payload_idx + 1));
            /* Jagwire - End */
            ...
            else
            {
                ...
                /* Jagwire */
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_size = sei_size;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload = sei_data;
                x4->pic.extra_sei.num_payloads = sei_payload_idx + 1;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_type = 4;
                sei_payload_idx++;
                /* Jagwire - End */
            }
        }
    ...
    if (x4->precision_ts)
    {
        ...
        else if (misp_sei_data)
        {
            ...
            else
            {
                ...
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_size = sei_size;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload = misp_sei_data;
                x4->pic.extra_sei.num_payloads = sei_payload_idx + 1;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_type = 5;
                sei_payload_idx++;
            }
        }
        ...
        else if (sync_sei_data)
        {
            ...
            else
            {
                ...
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_size = sei_size;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload = sync_sei_data;
                x4->pic.extra_sei.num_payloads = sei_payload_idx + 1;
                x4->pic.extra_sei.payloads[sei_payload_idx].payload_type = 5;
                sei_payload_idx++;
            }
