                          ...
                          int mb_y)
{
    ...
    int dxy, uvdxy, mx, my, src_x, src_y,
        uvsrc_x, uvsrc_y, v_edge_pos, block_y_half/* Jagwire */, check_height/* Jagwire - End */;
    ...
    if (ref_picture[0] == NULL || src_y > (check_height-(16*(1+s->cur_pic.ptr->field_picture)))>>s->cur_pic.ptr->field_picture) {
        return;
    }
    /* Jagwire - End */
